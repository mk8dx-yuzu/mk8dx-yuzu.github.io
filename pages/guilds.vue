<template>
	<div>
		...
		<div v-else class="guilds-container">
			...
			<!-- Static example data (probably outdated already lol)-->
			<!-- <div class="guild-card rank03diamond" @click="navToGuild('Merge Tactics Enjoyer')">
				<div class="guild-header">
					<div class="guild-rank-section">
						<div class="guild-rank">#1</div>
					</div>
					<div class="guild-logo-section">
						<img src="https://mergetacticsbuild.com/images/ranks/Diamond.png" alt="Guild Logo" class="guild-logo" />
					</div>
					<div class="guild-main-info">
						<div class="guild-title-section">
							<h3 class="guild-name">Merge Tactics Enjoyer</h3>
							<span class="guild-tag">MTE</span>
						</div>
						<div class="guild-stats">
							<div class="stat-item">
								<span class="stat-label">MMR</span>
								<span class="stat-value">3800</span>
							</div>
							<div class="stat-item">
								<span class="stat-label">Wins</span>
				...
				<div class="guild-members">
					...
					<div class="members-list">
						<span class="member-tag">Kevnkkm</span>
						<span class="member-tag">Probablyjassin</span>
						<span class="member-tag">Gurt</span>
					</div>
				</div>
			</div>

			<div class="guild-card rank02master" @click="navToGuild('Speed Demons')">
				<div class="guild-header">
					<div class="guild-rank-section">
						<div class="guild-rank">#2</div>
					</div>
					<div class="guild-logo-section">
						<img src="https://media.discordapp.net/attachments/1399632529392402514/1399632529643933807/Julandrones_Maricones.png?ex=68ed3e1e&is=68ebec9e&hm=e1581a37304c1a761b1d81ff1a09deef9478b868608ba15e91fce6d6680bccdb&=&format=webp&quality=lossless" alt="Guild Logo" class="guild-logo" />
					</div>
					<div class="guild-main-info">
						<div class="guild-title-section">
							<h3 class="guild-name">Julandrones Maricones</h3>
							<span class="guild-tag">JM</span>
						</div>
						<div class="guild-stats">
							<div class="stat-item">
								<span class="stat-label">MMR</span>
				...
				<div class="guild-members">
					<div class="members-header">
						<span class="members-title">Members</span>
						<span class="members-count">12</span>
					</div>
					<div class="members-list">
						<span class="member-tag">dalos</span>
						<span class="member-tag">tario</span>
						<span class="member-tag">leoo</span>
						<span class="member-tag">orb</span>
						<span class="member-tag">roquear</span>
						<span class="member-tag">juliocesar</span>
						<span class="member-tag">alephzero</span>
						<span class="member-tag">tesune</span>
						<span class="member-tag">float</span>
						<span class="member-tag">shyguay</span>
						<span class="member-tag">jerecraft</span>
						<span class="member-tag">fredric</span>
					</div>
				</div>
			</div>

			<div class="guild-card rank06platinum" @click="navToGuild('Shell Shock Squad')">
				<div class="guild-header">
					<div class="guild-rank-section">
						<div class="guild-rank">#3</div>
					</div>
					<div class="guild-logo-section">
						<img src="https://mergetacticsbuild.com/images/ranks/Platinum.png" alt="Guild Logo" class="guild-logo" />
					</div>
					<div class="guild-main-info">
						<div class="guild-title-section">
							<h3 class="guild-name">Having Unlimited Fun</h3>
							<span class="guild-tag">HUF</span>
						</div>
						<div class="guild-stats">
							<div class="stat-item">
								<span class="stat-label">MMR</span>
				...
				<div class="guild-members">
					<div class="members-header">
						<span class="members-title">Members</span>
						<span class="members-count">5</span>
					</div>
					<div class="members-list">
						<span class="member-tag">cars</span>
						<span class="member-tag">notniall</span>
						<span class="member-tag">jen</span>
						<span class="member-tag">probablyjassin</span>
						<span class="member-tag">snom</span>
					</div>
				</div>
			</div> -->
		</div>
...
/* Rank-based styling matching the main leaderboard */
/*
.guild-card.rank10wood {
	border-left: 4px solid #8B4513;
}

.guild-card.rank09bronze {
	border-left: 4px solid #CD7F32;
}

.guild-card.rank08silver {
	border-left: 4px solid #C0C0C0;
}

.guild-card.rank07gold {
	border-left: 4px solid #FFD700;
}

.guild-card.rank06platinum {
	border-left: 4px solid #E5E4E2;
}

.guild-card.rank03diamond {
	border-left: 4px solid #B9F2FF;
}

.guild-card.rank02master {
	border-left: 4px solid #FF6B6B;
}

.guild-card.rank01grandmaster {
