<template>
  <div>
    ...
    >
      ...
      >
        <p>
          This player is currently suspended and may no longer participate in
          MK8DX-yuzu Lounge.
        </p>
      </NoticeBanner>
        ...
        <div class="profile-container-inner">
          ...
          >
            <div class="player-not-found-content">
              ...
              <p>
                Player {{ name }} does not have any recorded data in Season
                {{ selectedSeason }}.
              </p>
              <p>
                Please select a different season above to view their stats.<br>(Or
                they might not even exist altogether)
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div class="overlay">
                ...
                <p>
                  Rank #{{
                    playerData.findIndex((obj) => obj.name === player.name) + 1
                  }}
                  serverwide
                </p>
              </div>
                ...
                <div class="player-guild-header">
                  ...
                  <div class="player-guild-main-info">
                    <div class="player-guild-title-section">
                      ...
                      <span class="player-guild-tag">{{
                        getGuildTag(playerGuild.name)
                      }}</span>
                      <span
                    ...
                    <div class="player-guild-stats">
                      ...
                      <div class="player-guild-stat-item">
                        ...
                        <span class="player-guild-stat-value">{{
                          playerGuild.wins
                        }}</span>
                      </div>
                      <div class="player-guild-stat-item">
...
const rankColors = computed(() => {
  ...
  const rank = getRank(
    player.value.mmr,
    playerData.value.indexOf(player.value)
  )
  const colorMap = {
...
const guildRank = computed(() => {
  ...
  return (
    guildData.value.findIndex(g => g.name === playerGuild.value.name) + 1
  )
})
...
useSeoMeta({
  title: computed(
    () =>
      `${player.value ? `${player.value.name}'s ` : ''}Player Profile - MK8DX-yuzu Lounge`
  ),
  description: computed(
    () =>
      `View ${player.value ? `the profile of ${player.value.name}, including` : 'player profiles including'} MMR, wins, losses, and guild affiliation${player.value ? '' : 's'} in the MK8DX-yuzu Lounge.`
  ),
  ogTitle: computed(
    () =>
      `${player.value ? `${player.value.name}'s ` : ''}Player Profile - MK8DX-yuzu Lounge`
...
.gradient-rank::before {
  ...
  /* transform: scale(0.9); */
  animation:
    animate-gradient-start-2 2s ease-out 1s 1 forwards,
    animate-gradient 2s linear 1s infinite reverse;
  mask-composite: intersect;
  opacity: 0.8;
}
...
.gradient-rank::after {
  ...
  /* transform: scale(1, 3); */
  animation:
    animate-gradient-start-3 2s ease-out 1s 1 forwards,
    animate-gradient 8s linear 1s infinite;
  mask-composite: intersect;
  opacity: 0.2;
}
