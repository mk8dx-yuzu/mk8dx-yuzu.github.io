<template>
  <div>
    <NoticeBanner color="purple">
      <p>
        Season 4 released! Check out the changes
        <a
          href="https://github.com/probablyjassin/bot-mk8dx-public/blob/main/README.md#the-4th-season-of-mk8dx-lounge-on-yuzu-online"
          target="_blank"
        >here!</a>
      </p>
    </NoticeBanner>
...
const { playerData, hasLoaded, isDataFromCache, loadPlayerData, animateTable }
  = usePlayerData()
...
const filteredPlayers = computed(() => {
  ...
  if (!searchQuery.value) {
    return playerData.value.filter(
      player => !(player['mmr'] == 2000 && player['wins'] == 0)
    )
  }
